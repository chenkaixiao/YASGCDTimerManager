//
//  YASGCDTimerManager.m
//
//
//  Created by chenkaixiao on 2017/10/13.
//  Copyright © 2017年 . All rights reserved.
//

#import "YASGCDTimerManager.h"


@interface YASGCDTimerManager ()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;

@end
@implementation YASGCDTimerManager
#pragma mark - Public Method

+ (YASGCDTimerManager *)sharedInstance {
    static YASGCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[YASGCDTimerManager alloc] init];
    });
...
- (void)scheduledDispatchTimerWithName:(NSString *)timerName
                          ...
                          actionOption:(YASGCDTimerManagerActionOption)option
    ...
    switch (option) {
        case YASGCDTimerManagerAbandonPreviousAction: {
            /* 移除之前的action */
        ...
        case YASGCDTimerManagerMergePreviousAction: {
            /* cache本次的action */
